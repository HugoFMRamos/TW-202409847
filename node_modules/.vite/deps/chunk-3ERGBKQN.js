...
} from "./chunk-OBXPAYK2.js";
import {
  UniformBuffer
} from "./chunk-I6DACCA3.js";
import {
  Axis,
  Engine,
  Frustum,
...
import {
  Texture
} from "./chunk-UHAO3HP3.js";
import {
  SerializationHelper,
  Tags
} from "./chunk-5BYE6PJE.js";
import {
  Color3,
  Color4,
  TmpColors
...
import {
  ...
  EffectWrapper,
  Viewport
} from "./chunk-XPZWSLNM.js";
import {
  VertexBuffer
} from "./chunk-LAFJMI44.js";
import {
  Tools
} from "./chunk-LTOOUVNW.js";
import {
  __decorate,
  expandToProperty,
  serialize,
...
var FrameGraphRenderPass = class extends FrameGraphPass {
  ...
  _execute() {
    ...
    if (renderTargetWrapper && (renderTargetWrapper.resolveMSAAColors || renderTargetWrapper.resolveMSAADepth || renderTargetWrapper.resolveMSAAStencil)) {
      this._context.bindRenderTarget(void 0, `frame graph render pass - ${this.name} - resolve MSAA`, true);
      this._context._flushDebugMessages();
    }
  }
  /** @internal */
...
var ThinBlurPostProcess = class _ThinBlurPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(Promise.all([import("./kernelBlur.fragment-HVFBX3P2.js"), import("./kernelBlur.vertex-Q72BXLNC.js")]));
    } else {
      list.push(Promise.all([import("./kernelBlur.fragment-AMU3ZOH4.js"), import("./kernelBlur.vertex-WCQSS74M.js")]));
    }
  }
  /**
...
var ShadowGenerator = class _ShadowGenerator {
  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_ShadowGenerator.ForceGLSL) {
      ...
      await Promise.all([
        import("./shadowMap.fragment-4QTW5J7Y.js"),
        import("./shadowMap.vertex-QVUGW2VS.js"),
        import("./depthBoxBlur.fragment-DQWPVCHL.js"),
        import("./shadowMapFragmentSoftTransparentShadow-LMRLYFVD.js")
      ]);
    } else {
      await Promise.all([
        import("./shadowMap.fragment-Y4QJYVFT.js"),
        import("./shadowMap.vertex-5ONWC4Z5.js"),
        import("./depthBoxBlur.fragment-6RO74A55.js"),
        import("./shadowMapFragmentSoftTransparentShadow-ZRXXUGGJ.js")
      ]);
    }
...
var DepthRenderer = class _DepthRenderer {
  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_DepthRenderer.ForceGLSL) {
      this._shaderLanguage = 1;
      await Promise.all([import("./depth.vertex-OWU2272B.js"), import("./depth.fragment-WITAIOBP.js")]);
    } else {
      await Promise.all([import("./depth.vertex-2BA5ZI3P.js"), import("./depth.fragment-2HTWMXY2.js")]);
    }
    this._shadersLoaded = true;
  }
  /**
...
//# sourceMappingURL=chunk-3ERGBKQN.js.map
